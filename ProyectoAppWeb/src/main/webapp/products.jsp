...
<html lang="es">
  ...
  <head>
    ...
    <title>Botas Jusaino - Productos</title>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="inner-content">
                        ...
                        <span>Explora nuestro catálogo y encuentra el producto ideal para ti o tus seres queridos.</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-heading">
                        ...
                        <span>Lo último en Botas Jusaino.</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="item">
                        ...
                        <div class="down-content">
                            <h4>Botas de baile para hombre</h4>
                            <span>$550.00</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4">
                    <div class="item">
                        <div class="thumb">
                            ...
                            <img src="assets/images/cinto01.jpg" alt="">
                        </div>
                        <div class="down-content">
                            <h4>Cinturón para hombre</h4>
                            <span>$250.00</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="item">
                        <div class="thumb">
                            ...
                            <img src="assets/images/funda01.jpg" alt="">
                        </div>
                        <div class="down-content">
                            <h4>Funda para navaja</h4>
                            <span>$150.00</span>
                        </div>
                    </div>
                </div>
